...
class Mssql:
    """
    This class is supposed to do dirty work. A lot of hardcoded parameters etc.

    That's ok, it have to be delivered "right now!", so... feel free to improve it.
    """
    ...
    def gera_dados_alunos(self):
        ...
        for dados in apenas_alunos:
            ...
            dados_aluno['matricula'] = dados['codext'].encode('latin-1')
            dados_aluno['nome'] = dados['nome'].encode('latin-1')
